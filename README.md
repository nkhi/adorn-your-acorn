...
<div class="box">
    ...
    <a class="copy-link tooltip" data-tooltip="This converts your open tab into a PDF\n(Click to Copy)" onClick="copyPrintPDFCode();" >
...
<script>
    function copyPrintPDFCode() {
        ...
        el.value = `this should be html2pdf bundled code`;
