...
<script> 
    ...
    function hide(){
        ...
        if (l.attributes[1].value == "you're looking at the script you just copied"){
            q.style.visibility='hidden';
            l.attributes[1].value="i pretend i simply do not see it";
        ...
        } else if (l.attributes[1].value="i pretend i simply do not see it") { 
            q.style.visibility='visible';
            l.attributes[1].value="you're looking at the script you just copied";
