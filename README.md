...
<div class="box">
    ...
    <div class="copy-button css-selector">
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="#ffffff" viewBox="0 0 256 256"><rect width="256" height="256" fill="#ffffff"></rect><path d="M215.99414,31.99316h-128a8.0004,8.0004,0,0,0-8,8v40.001h-40.001a8.0004,8.0004,0,0,0-8,8v128a8.0004,8.0004,0,0,0,8,8h128a8.00039,8.00039,0,0,0,8-8v-40.001h40.001a8.00039,8.00039,0,0,0,8-8v-128A8.0004,8.0004,0,0,0,215.99414,31.99316Zm-8,128h-32.001v-71.999a8.00039,8.00039,0,0,0-8-8h-71.999v-32.001h112Z"></path></svg>
    </div>
</div>

**Step 1:** Drag the squirrels above into your bookmarks bar and click on the Copy button  
...
**Step 4:** Click the squirrels! They'll clean up the page.  
**Step 5:** Hit `F12`, click on the Console tab at the top, and paste the code you copied. This part might take a while, please be patient. Click enter once it responds. 
