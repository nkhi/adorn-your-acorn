...
if (window.location.href == 'https://acorn.utoronto.ca/sws/#/history/academic') {
    ...
    if (v.length > 0) {
        ...
        if (parseInt(ii) != 'NaN' && parseInt(ii)>-1 && parseInt(ii) < 12) {
            ...
            ps[2].style.border='1px solid #e8e8e8';
            ps[2].style.borderTop='none';
            ps[2].style.borderBottom='none';
            ps[2].style.width='97.34%';
            ps[2].style.marginBottom='0';
            ...
            for (k=0; k<u.length; k++) {
                ...
                u[k].style.border='1px solid #e8e8e8';
                u[k].style.borderTop='none';
                u[k].style.borderBottom='none';
            };
            ...
            for (y=0;y<ttls.length;y++){
                ...
                ttls[y].style.borderTop='none';
            };
            for (s=0;s<ttls.length;s++){
                if (ttls[s].previousElementSibling.localName == 'p') {
                    ttls[s].style.borderTop='1px solid #e8e8e8';
                    ttls[s].style.borderTopLeftRadius='7px';
                    ttls[s].style.borderTopRightRadius='7px';
                };
            };
